<?php
// Configuration de la base de données (127.0.0.1 résout le problème de socket MySQL/XAMPP)
...
// Configuration email
define('EMAIL_FROM', 'StockMaster <no-reply@votre-domaine.com>');
define('EMAIL_REPLY_TO', 'commandes@votre-domaine.com');
define('PHONE_NUMBER', '+237 XXX XXX XXX');

// Super admin (alertes WhatsApp / email)
define('ADMIN_WHATSAPP', '237670000000'); // format international sans +
define('ADMIN_EMAIL', 'admin@stock.com');
