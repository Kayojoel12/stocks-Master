...
// === Vérification des constantes (sécurité) ===
if (!defined('COMPANY_NAME')) define('COMPANY_NAME', 'StockMaster');
if (!defined('PHONE_NUMBER')) define('PHONE_NUMBER', '+237 XXX XXX XXX');

// Vérification des droits (admin, superviseur, gestionnaire)
